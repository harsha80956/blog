...
const ADD_POST = gql`
  mutation AddPost($title: String!,$topic:String! $body: String!, $posted: DateTime!, $image: Upload!) {
    createPost(data: { title: $title,topic: $topic body: $body, posted: $posted, image: $image }) {
      id
      slug
    }
  }
